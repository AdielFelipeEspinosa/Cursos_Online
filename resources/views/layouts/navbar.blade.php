        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    @if (Route::has('login'))
                    @auth
                    <a class="btn btn-primary py-2 px-4 mx-2 ml-auto d-none d-lg-block" href="/">{{ Auth::user()->name }}</a>
                    ...
                    @else
                    <a class="btn btn-primary py-2 px-4 mx-2 ml-auto d-none d-lg-block" href="/login">Login</a>
                    <a class="btn btn-primary py-2 px-4 mx-2 d-none d-lg-block" href="/register">Registrar</a>
                    @endauth
                    @endif
